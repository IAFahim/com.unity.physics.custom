...
namespace Unity.Physics.Editor
{
    ...
    internal class PhysicsShapeAuthoringEditor : BaseEditor
    {
        ...
        private static readonly PhysicsCapsuleBoundsHandle s_Capsule =
            new() { heightAxis = CapsuleBoundsHandle.HeightAxis.Z };
        ...
        private static readonly BoxBoundsHandle s_Plane =
            new() { axes = PrimitiveBoundsHandle.Axes.X | PrimitiveBoundsHandle.Axes.Z };
        ...
        private void UpdateGeometryState()
        {
            ...
            foreach (PhysicsShapeAuthoring shape in targets)
            {
                ...
                {
                    var customMesh = so.FindProperty(m_CustomMesh.propertyPath).objectReferenceValue as Mesh;
                    if (customMesh != null)
                    {
        ...
        private static class Styles
        {
            ...
            public static readonly GUIStyle ButtonDropDown =
                new(EditorStyles.popup) { alignment = TextAnchor.MiddleCenter };
        ...
        private class PreviewMeshData : IDisposable
        {
            ...
            private readonly Dictionary<JobHandle, NativeArray<BlobAssetReference<Collider>>> m_PreviewJobsOutput =
                new();
            ...
            private JobHandle ScheduleMeshPreview(PhysicsShapeAuthoring shape,
                NativeArray<BlobAssetReference<Collider>> output)
            {
