...
namespace Unity.Physics.Authoring
{
    public class RotationalMotor : BaseJoint
    {
        ...
        [Tooltip(
            "A ratio describing how quickly a motor will arrive at the target. A value of 0 will oscillate about a solution indefinitely, while a value of 1 critically damped. Default value is 2530.126 which describes a stiff spring")]
        ...
        private class RotationalMotorBaker : JointBaker<RotationalMotor>
        {
